...
class TeamdynamixConnector(BaseConnector):
    def __init__(self):
        ...
        super(TeamdynamixConnector, self).__init__()
    ...
    def _handle_set_status(self, param):
        ...
        # make rest call
        ret_val, response = self._make_rest_call(
            '/api/{app_id}/tickets/{ticket_id}/feed', action_result, params=None, headers=None
        )
...
def main():
    ...
    if username and password:
        try:
            login_url = TeamdynamixConnector._get_phantom_base_url() + '/login'
    ...
    with open(args.input_test_json) as f:
        ...
        connector = TeamdynamixConnector()
